...
describe('Test cases de modulo <SPAC/Mantenimiento/Desvio de inyecciones/Configuracion de contactos>', () => { // corregir describe
  ...
  it.only('us1127 - Validar editar contacto', () => {
    ...
    cy.get('.MuiTableBody-root.tables_body') // pick table
      ...
      cy.get('.MuiGrid-root actionBars.MuiGrid-container.MuiGrid-align-items-xs-center.MuiGrid-justify-content-xs-flex-end')
      .find('.MuiButtonBase-root.MuiButton-root.MuiButton-text.MuiButton-textPrimary.MuiButton-textSizeSmall.MuiButton-sizeSmall.Mui-disabled Mui-disabled') // select edit button
      .click()
      cy.get('#message-id').should('exist')
