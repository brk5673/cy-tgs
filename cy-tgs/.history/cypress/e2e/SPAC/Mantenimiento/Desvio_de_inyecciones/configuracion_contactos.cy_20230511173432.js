...
describe('Test cases de modulo <SPAC/Mantenimiento/Desvio de inyecciones/Configuracion de contactos>', () => { // corregir describe
  ...
  it.only('us1127 - Validar editar contacto', () => {
    ...
    cy.get('.MuiTableBody-root.tables_body') // pick table
      ...
      cy.get('.MuiGrid-root actionBars MuiGrid-container MuiGrid-align-items-xs-center MuiGrid-justify-content-xs-flex-end actionBars > :nth-child(1) > .MuiButton-label').click()
      cy.get('#message-id').should('exist')
