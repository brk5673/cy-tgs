...
describe('Test cases de modulo Estado de Sistema', () => { // corregir describe
  ...
  it.only('us851 - Validacion Agregar nuevo estado', () => {
    ...
    cy.get('.MuiDialogContent-root.commonDialog_content .MuiInputBase-input.MuiInput-input.MuiAutocomplete-input.MuiAutocomplete-inputFocused.MuiInputBase-inputAdornedEnd').eq(1) // select 'estado' dropdown
      .type('alerta{enter}')
    cy.get('.MuiDialogContent-root.commonDialog_content .MuiInputBase-input.MuiOutlinedInput-input.MuiInputBase-inputMultiline.MuiOutlinedInput-inputMultiline').clear() // select 'observaciones' input
    //falta terminar
  })
