...
describe('Test cases de modulo Estado de Sistema', () => { // corregir describe
  ...
  it.only('us830 - Validar usuario con acceso y pantalla inicial de <Estado del sistema>', () => {
    ...
    cy.get('[name="inicial"]').clear().type('01122022')
      cy.get('[name="inicial"][value="01/12/2022"]').should('exist')
    cy.get('[name="final"]').clear().type('28022023')
      cy.get('[name="final"][value="28/02/2023"]').should('exist')
