  ...
  it('login exitoso con credenciales validas', () => {
    ...
    .then((response) => {
      ...
      cy.getAllCookies().then(cookies=>{
        ...
        expect(token_cookie, 'verificar existencia de un token de nombre').to.have.property('name').eq('JSESSIONID', 'que sea igual a JSEES');
        expect(token_cookie, 'verificar longitud de token').to.have.property('value').to.have.length.of.at.least(30)
