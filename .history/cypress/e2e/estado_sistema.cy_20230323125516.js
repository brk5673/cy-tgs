...
describe('Test cases de modulo Estado de Sistema', () => { // corregir describe
  ...
  it.only('us851 - Validacion Agregar nuevo estado', () => {
    ...
    cy.get('.MuiDialogContent-root.commonDialog_content .MuiInputBase-input.MuiInput-input.MuiInputBase-inputAdornedStart.MuiInputBase-inputAdornedEnd') // select datepicker in popup
      .clear().type('16032023')
    cy.get('.MuiDialogContent-root.commonDialog_content .MuiInputBase-input.MuiInput-input.MuiAutocomplete-input.MuiAutocomplete-inputFocused.MuiInputBase-inputAdornedEnd').click()
    //falta terminar
  })
