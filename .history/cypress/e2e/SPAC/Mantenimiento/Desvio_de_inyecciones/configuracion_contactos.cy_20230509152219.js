...
describe('Test cases de modulo <SPAC/Mantenimiento/Desvio de inyecciones/Configuracion de contactos>', () => { // corregir describe
  ...
  it.only('us1126 - Validar accion "Agregar nuevo"', () => {
    ...
    //cy.contains('Gasoducto: *').click()

    cy.get('.MuiInputBase-inputMuiInput-input.MuiAutocomplete-input.MuiAutocomplete-inputFocused.MuiInputBase-inputAdornedEnd').click()

    //cy.get('.MuiButtonBase-root.MuiIconButton-root.MuiAutocomplete-popupIndicator').click()
