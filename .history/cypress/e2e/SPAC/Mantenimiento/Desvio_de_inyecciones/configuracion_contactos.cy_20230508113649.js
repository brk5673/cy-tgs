...
describe('Test cases de modulo <SPAC/Mantenimiento/Desvio de inyecciones/Configuracion de contactos>', () => { // corregir describe
  ...
  it.only('us1120 - Validacion del menu, pantalla y carga inicial', () => {
    ...
    //exportar grilla
    cy.get('div.HeaderSvgCustomIcon.ExcelIcon').should('exist').click()
    cy.get('div.HeaderSvgCustomIcon.PdfIcon').should('exist').click()
    cy.get('svg.MuiSvgIcon-root.HeaderSvgCustomIcon.PrintIcon').should('exist').click()
