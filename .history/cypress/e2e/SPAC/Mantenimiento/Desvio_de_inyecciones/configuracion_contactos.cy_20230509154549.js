...
describe('Test cases de modulo <SPAC/Mantenimiento/Desvio de inyecciones/Configuracion de contactos>', () => { // corregir describe
  ...
  it.only('us1126 - Validar accion "Agregar nuevo"', () => {
    ...
    cy.get(':nth-child(2) > .MuiAutocomplete-root > .MuiFormControl-root').click().type('CINERGIA (755){enter}')
    cy.get(':nth-child(3) > .MuiAutocomplete-root > .MuiFormControl-root').click().type('Javier Val{enter}')
