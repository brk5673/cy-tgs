...
describe('Test cases de modulo <SPAC/Control/Consulta de Desvio de Inyecciones>', () => {
  ...
  it('us1080 - Validacion del menu, pantalla y carga inicial', () => {
    ...
    cy.contains('span.MuiListItemText-primary', 'Consulta de Desvio de Inyecciones').click({force})
    cy.wait(1000)
  ...
  it.only('us1081 - Validar listado desvio inyecciones', () => {
    ...
    cy.get('.MuiGrid-root.MuiGrid-item.MuiGrid-grid-xs-12.MuiGrid-grid-md-6.MuiGrid-grid-lg-6').eq(0).click().clear() // clear inicial date
