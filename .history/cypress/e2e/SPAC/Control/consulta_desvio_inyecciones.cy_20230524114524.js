...
describe('Test cases de modulo <SPAC/Control/Consulta de Desvio de Inyecciones>', () => {
  ...
  it.only('us1080 - Validacion del menu, pantalla y carga inicial', () => {
    ...
    cy.get('.MuiTypography-root.MuiTypography-body1.MuiTypography-colorTextSecondary').eq(1).click().clear().type('0530')
    cy.get('.MuiTypography-root.MuiTypography-body1.MuiTypography-colorTextSecondary').eq(3).click().clear().type('1830')
