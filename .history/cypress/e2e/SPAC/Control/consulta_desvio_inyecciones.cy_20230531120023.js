...
describe('Test cases de modulo <SPAC/Control/Consulta de Desvio de Inyecciones>', () => {
  ...
  it.only('us1081 - Validar listado desvio inyecciones', () => {
    ...
    cy.get('.MuiPaper-root.MuiDialog-paper.MuiDialog-paperScrollPaper.MuiDialog-paperWidthSm.MuiDialog-paperFullWidth.MuiPaper-elevation24.MuiPaper-rounded').contains()
